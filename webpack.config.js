...
const entryPath = path.resolve(__dirname, 'src/javascript', 'main');
...
module.exports = {
  ...
  resolve: {
    alias: {
      modernizr: path.join(__dirname, 'src/javascript/vendor/modernizr.custom.js'),
      lodash: path.join(__dirname, 'src/javascript/vendor/lodash.custom.js'),
    }
  },
  module: {
    noParse: ['modernizr'],
